...
class Brain(QObject):
    ...
    def __init__(self):
        ...
        self.services.register("app", AppService())
        self.services.register("browser", BrowserService())
        self.services.register("system", SystemService())
        self.services.register("desktop", DesktopService())
        self.services.register("screen", ScreenService())
        self.services.register("files", FileService())
        self.services.register("media", MediaService())
        self.services.register("clipboard", ClipboardService())
    ...
    def process(self, text):
        ...
        if not valid or any(task.action == "CHAT" for task in plan):
    ...
    def inspect_screen(self, semantic=False):
        ...
        if not service:
            return {"error": "Screen service unavailable."}
        return service.inspect(semantic=semantic)
